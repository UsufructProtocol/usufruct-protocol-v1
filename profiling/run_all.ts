...
const SENTINEL: Record<string, string> = {
  ...
  'a_atomic/04_soft_burn.ts':               'results/a_04_soft_burn.json',
  'a_atomic/05_hard_burn.ts':               'results/a_05_hard_burn.json',
  ...
  'a_atomic/10_extend_commitment.ts':       'results/a_10_extend_commitment.json',
