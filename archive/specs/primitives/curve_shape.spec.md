...
| **[new]** `2_000_000_000` | `4_000_000_000` | `1` | `2` | `707_106_781` | α = 1/2 at midpoint `t = t_max/2`; floor(√0.5 · SCALE), √0.5 ≈ 0.707106781… Reflection-on-diagonal pair with the integer-exact row `(t=1·10⁹, t_max=2·10⁹, 2, 1) → 250_000_000`: that row gives the convex midpoint `(0.5, 0.25)`; this row gives the concave midpoint `(0.5, ≈0.707)`. The two are NOT complementary (`0.25 + 0.707 ≠ 1`) — PowerLaw lacks Exp's complementarity. They satisfy reflection on `y = x`: the point `(0.5, 0.25)` reflects to `(0.25, 0.5)` which lies on this curve since `0.25^0.5 = 0.5`. See "Reflection on diagonal" property below. |
