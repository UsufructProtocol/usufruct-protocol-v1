...
**Cap management**
- `asset_state::execute_soft_burn_usufruct_cap<Asset, C>(&AssetState, &EscrowCore<C>, cap: UsufructCap, clock, ctx)` — burns a stale cap; asserts it is neither current nor pending.
