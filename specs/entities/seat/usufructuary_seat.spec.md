...
- `usufructuary_seat::new<C>(cap_identity: UsufructCapIdentity, address: address, balance: Balance<C>): UsufructuarySeat<C>`
...
- `usufructuary_seat::take_earnings<C>(&mut UsufructuarySeat<C>, amount: Stake): EarningsBalance<C>` — splits `amount` mist from stake into governor earnings; used during settlement.
